...
public class DoYouSmokeActivity extends AppCompatActivity implements OnChipClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(context,DoYouUseCannabisActivity.class));
            }
        });
    }
