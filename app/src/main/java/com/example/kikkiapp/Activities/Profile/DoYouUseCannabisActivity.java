...
public class DoYouUseCannabisActivity extends AppCompatActivity implements OnChipClickListener {
    ...
    private void getIdentity() {
        ...
        callbackGetCategoryCall = api.getCategory(sessionManager.getAccessToken(), Constant.CANNABIS);
