...
public class LastMessageService implements ChildEventListener, ValueEventListener {
    ...
    public LastMessageService(String senderId, String receiverId) {
        mLanguagePreference1 = FirebaseDatabase.getInstance().getReference("LastMessages").child(senderId+"___"+receiverId);
        mLanguagePreference2 = FirebaseDatabase.getInstance().getReference("LastMessages").child(receiverId+"___"+senderId);
