...
public class SingleMessagingService implements ChildEventListener, ValueEventListener {
    ...
    public SingleMessagingService(String senderId, String receiverId) {
        mLanguagePreference1 = FirebaseDatabase.getInstance().getReference("Chats").child(senderId+"___"+receiverId);
        mLanguagePreference2 = FirebaseDatabase.getInstance().getReference("Chats").child(receiverId+"___"+senderId);
