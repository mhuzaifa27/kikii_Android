...
public class AttendingsAdapter extends RecyclerView.Adapter<AttendingsAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;

    public AttendingsAdapter(List<String> data, Context context) {
        this.data = data;
